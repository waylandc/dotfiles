...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (auto-complete-config subatomic256-theme gotham-theme ample-theme typescript-mode dash-functional web-mode shrink-path protobuf-mode powerline material-theme magit kaolin-themes json-mode js2-mode gotest go-eldoc go-autocomplete flycheck eldoc-eval doom-themes company-go autopair))))
(custom-set-faces
