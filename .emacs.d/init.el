...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
	(company-lsp dap-mode go-tag gotest company-quickhelp company-box company-posframe 4clojure molokai-theme cargo rainbow-mode flymake-go twilight-bright-theme solarized-theme auto-complete-config go-snippets go-guru company-go go-mode use-package))))
(custom-set-faces
